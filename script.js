...
export const gameDetails = {
  ...
  startingRoomDescription:
    "What you see before you is the lobby of a Mexican restaurant, from here you can go to the kitchen",
  playerCommands: [
...
let lobby = new Location(
  ["kitchen"],
  "host are front of house, from here you can go to the kitchen",
  ["matches", "couch"]
);
console.log(lobby);
...
let kitchen = new Location(
  ["busCloset", "lobby"],
  "a place where one cooks, from here you can go to the busCloset",
  ["pot", "stove"]
);
console.log(kitchen);

let busCloset = new Location(
  ["bathroom", "kitchen"],
  "a closet with basic restaurant supplies, from here you can go to the bathroom",
  ["cup", "fountain"]
);
console.log(busCloset);

let bathroom = new Location(
  ["window"],
  "a room with toilets and sinks, from here you can leave from the window",
  ["tissue", "toilet"]
);
...
export const domDisplay = (playerInput) => {
  ...
  if (command === "enter" && currentLocation.avaibleExits.includes(target)) {
    ...
    command === "pickup" &&
    currentLocation.accessItems.includes(target)
  ) {
    ...
    if (items[target].move === true) {
      playerInventory.push(items[target].name);
    } else {
      return `${items[target].name} not able to be moved`;
    }

    return items[target].description;
    console.log("this works");
    //code picking up object
  } else if (command === "view" && target === "inventory") {
